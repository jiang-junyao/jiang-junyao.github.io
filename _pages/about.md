...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Nature Cell Biology (Major revision)</div><img src='images/fateGRN.png' alt="sym" width="100%"></div></div>
...
<div style="font-style: italic; color: #555; margin-bottom: 30px; line-height: 1.8; max-width: 90%; border-left: 3px solid #ccc; padding-left: 18px; font-family: 'Georgia', serif;">
  <p style="margin-bottom: 10px; font-size: 1.05em;">
    在代码与数据中破译细胞的命运固然迷人，但走出实验室去拥抱辽阔的旷野，才是生命最生动的具象化。我不是专业的摄影师，但我知道生命是一场短暂而烂漫的旅途，意义全在体验之中。我想在这里留下我走过的岁月与山河，以表达我对生命的热爱。
  </p>
  <p style="margin-bottom: 0; font-size: 0.9em; color: #777;">
    "Deciphering the fate of cells through code and data is undeniably fascinating, but stepping out of the lab to embrace the vast wilderness is the most vivid embodiment of life itself. I am not a professional photographer, but I know that life is a fleeting and brilliant journey, and its meaning lies entirely in the experience. I wish to leave behind the years and landscapes I have traversed here, as an expression of my deep love for life."<br>
    <span style="font-size: 0.8em; color: #aaa;">— English text generated by Gemini</span>
  </p>
</div>
...
<script type='text/javascript' id='mapmyvisitors' src='https://mapmyvisitors.com/map.js?cl=ffffff&w=250&t=tt&d=Sh4k0tJqJ3qZyNmvueaYMsPVgNj7_uJAuA9hJ3QqHCM'></script>